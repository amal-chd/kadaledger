    ...
    return (
        <CustomerViewProvider>
            <div className="min-h-screen bg-slate-50 dark:bg-[#020617] flex relative overflow-hidden transition-colors duration-300">
                ...
                {/* Sidebar */}
                <aside className="w-64 bg-white dark:bg-[#0f172a]/60 backdrop-blur-xl border-r border-slate-200 dark:border-white/5 fixed h-full z-20 hidden md:block transition-colors duration-300">
