    ...
    const stats = [
        {
            ...
            value: `₹${dashboardStats?.totalOutstanding?.toLocaleString() || '0'}`,
            icon: Wallet,
            color: 'text-red-600',
        ...
        },
        {
            ...
            value: `₹${dashboardStats?.todaysActivity?.payments?.toLocaleString() || '0'}`,
            icon: TrendingDown,
        ...
        },
        {
            ...
            value: `₹${dashboardStats?.todaysActivity?.credits?.toLocaleString() || '0'}`,
            icon: TrendingUp,
        ...
        },
        {
            ...
            value: dashboardStats?.defaulterSummary?.count || '0',
            // fallback to defaulter count if total not in stats, but ideally stats should have total customers. 
            // Investigating stats API, it has customers.reduce. Let's use profile if available.
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                >
                    ...
                    <div className="space-y-4">
                        {dashboardStats?.highRiskCustomers?.length > 0 ? (
                            dashboardStats.highRiskCustomers.map((c: any) => (
                                <div
                                    key={c.id}
